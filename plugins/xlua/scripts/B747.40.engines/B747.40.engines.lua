...
B747DR_thrust_mnp_show				= create_dataref("laminar/B747/engine/thrust_mnp_show", "array[4)")
B747DR_thrust_mnp_show_all			= create_dataref("laminar/B747/engine/thrust_mnp_show_all", "number")

B747DR_reverse_mnp_show				= create_dataref("laminar/B747/engine/rev_mnp_show", "array[4)")
B747DR_reverse_mnp_show_all			= create_dataref("laminar/B747/engine/rev_mnp_show_all", "number")

B747DR_engine_fuel_valve_pos        = create_dataref("laminar/B747/engines/fuel_valve_pos", "array[4)")
B747DR_EICAS2_fuel_on_ind_status    = create_dataref("laminar/B747/engines/fuel_on_indicator_status", "array[4)")
B747DR_EICAS2_oil_press_status      = create_dataref("laminar/B747/engines/EICAS2_oil_press_status", "array[4)")
B747DR_EICAS2_engine_vibration      = create_dataref("laminar/B747/engines/vibration", "array[4)")
B747DR_engine_oil_press_psi         = create_dataref("laminar/B747/engines/oil_press_psi", "array[4)")
B747DR_engine_oil_temp_degC         = create_dataref("laminar/B747/engines/oil_temp_degC", "array[4)")
B747DR_engine_oil_qty_liters        = create_dataref("laminar/B747/engines/oil_qty_liters", "array[4)")
B747DR_EPR_max_limit                = create_dataref("laminar/B747/engines/EPR/max_limit", "array[4)")
B747DR_EGT_amber_inhibit            = create_dataref("laminar/B747/engines/EGT/amber_inhibit", "array[4)")
B747DR_EGT_amber_on                 = create_dataref("laminar/B747/engines/EGT/amber_on", "array[4)")
B747DR_EGT_white_on                 = create_dataref("laminar/B747/engines/EGT/white_on", "array[4)")

B747DR_init_engines_CD              = create_dataref("laminar/B747/engines/init_CD", "number")

B747DR_engine_TOGA_mode             = create_dataref("laminar/B747/engines/TOGA_mode", "number")

B747DR_ref_thr_limit_mode           = create_dataref("laminar/B747/engines/ref_thr_limit_mode", "string")
...
-- AI
B747CMD_ai_engines_quick_start		= create_command("laminar/B747/ai/engines_quick_start", "number", B747_ai_engines_quick_start_CMDhandler)
